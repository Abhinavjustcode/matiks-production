...
const problems = [
    {
        ...
        title: "Two Sum",
        difficulty: "EASY",
        description: "Given an array of integers and a target integer, return the indices of the two numbers whose sum equals the target. Return the indices in any order.",
        starterCode: {
...
`,
    ...
    },
    {
        ...
        difficulty: "MEDIUM",
        description: "Given a string containing parentheses, brackets and braces, determine whether the input string is valid.",
        starterCode: {
...
`,
    ...
    },
    {
        ...
        title: "Binary Search",
        difficulty: "MEDIUM",
        description: "Given a sorted array of distinct integers and a target, return the target index or -1.",
        starterCode: {
